module.exports = {
  baseUrl: 'https://101cookbooks.com/',
  sourceName: '101 Cookbooks',
  domain: '101cookbooks',
  recipes: [{
    url: 'https://www.101cookbooks.com/coleslaw-recipe/',
    publishDate: '2019-06-14',
    expectedRecipe: {
      name: 'Lime & Blistered Peanut Coleslaw',
      servings: 8,
      imageUrl: 'https://images.101cookbooks.com/coleslaw-recipe-h.jpg',
      thumbnailUrl: 'https://images.101cookbooks.com/coleslaw-recipe-h.jpg?w=680&auto=format',
      source: {
        name: '101 Cookbooks',
        domain: '101cookbooks',
        url: 'https://www.101cookbooks.com/coleslaw-recipe/',
